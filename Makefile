...
CATEGORY_LIMIT_COUNTS ?= [600,700,800,100,800,0,400,300,700]
...
help:
	...
	@echo "  make extend-data-from-generated # data/generated/YYYY-MM-DD-HH-MM に problem/reasoning/corpus を生成"
...
extend-data-from-generated: raw-data
	DATA_DIR=$(GENERATED_RUN_DIR) TRAIN_CSV=$(GENERATED_TRAIN_CSV) $(UV) scripts/gen_data/gen_problems.py
	DATA_DIR=$(GENERATED_RUN_DIR) TRAIN_CSV=$(GENERATED_TRAIN_CSV) $(UV) scripts/gen_data/gen_reasoning.py
	DATA_DIR=$(GENERATED_RUN_DIR) TRAIN_CSV=$(GENERATED_TRAIN_CSV) $(UV) scripts/gen_data/gen_corpus.py
...
train-model-from-generated: extend-data-from-generated
	DATA_DIR=$(GENERATED_RUN_DIR) $(UV) scripts/train/sft.py $(TRAIN_GENERATED_ARGS)
...
train-model-from-pretrained-generated: extend-data-from-generated
	...
	DATA_DIR=$(GENERATED_RUN_DIR) $(UV) scripts/train/sft.py $(TRAIN_FROM_PRETRAINED_GENERATED_ARGS)
train-model-modal:
	$(UV_MODAL_DEPLOY) scripts/train/sft.py $(TRAIN_ARGS)
train-model-modal-generated: extend-data-from-generated
	DATA_DIR=$(GENERATED_RUN_DIR) $(UV_MODAL_DEPLOY) scripts/train/sft.py $(TRAIN_GENERATED_ARGS)

upload-adapter:
	$(UV) scripts/submit/upload_adapter_to_kaggle.py
